...
module.bundle.HMR_BUNDLE_ID = "d1ff378fbde1fdf4";
"use strict";
...
function checkInput() {
    ...
    if (title.length < 1 || workplace.length < 1 || employer.length < 1 || startdate.length < 1 || enddate.length < 1 || description.length < 1) errorSpaceEl.innerHTML = "Fyll i alla textf\xe4lt!";
